...
chain = (
    ...
    | {
        "investment_recommendation": {
            "financial_analysis": RunnablePick(keys=["financial_analysis"]),
            "risk_tolerance": RunnablePick(keys=["original_input", "risk_tolerance"]),
            "investment_years": RunnablePick(
                keys=["original_input", "investment_years"]
            ),
        }
        | create_investment_recommendation_chain(),
        "original_input": RunnablePick(keys=["original_input"]),
        "financial_analysis": RunnablePick(keys=["financial_analysis"]),
    }
)
...
st.set_page_config(
    page_title="Financial Health Analysis", page_icon="💰", layout="wide"
)
...
if analyze_button:
    ...
    st.info(
        "Enter your financial details in the sidebar and click 'Analyze Financial Health' to get started."
    )
